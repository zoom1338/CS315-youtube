...
df_comments = pd.read_csv("../data/UScomments_clean.csv", encoding='utf-8')
...
plt.title('Commets sorted US by Sentiment Type')
...
# Saving the file
output_path = os.path.join(os.path.dirname(__file__), "UScomments.png")
